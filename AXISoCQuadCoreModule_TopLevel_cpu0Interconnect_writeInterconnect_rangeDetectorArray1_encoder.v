...
//
// System configuration name is AXISoCQuadCoreModule_TopLevel_cpu0Interconnect_writeInterconnect_rangeDetectorArray1_encoder, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module AXISoCQuadCoreModule_TopLevel_cpu0Interconnect_writeInterconnect_rangeDetectorArray1_encoder
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire iValues0,
	...
	output wire [1:0] MSBIndex,
	output wire [3:0] MSBValue
);
	// [BEGIN USER SIGNALS]
	// [END USER SIGNALS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire signed [3: 0] inputWidth = 4'b0100;
	wire signed [2: 0] resultWidth = 3'b010;
	wire AXI4EncoderModule_L31F46T51_Expr = 1'b0;
	wire AXI4EncoderModule_L46F31T36_Expr = 1'b0;
	wire [1: 0] internalEncoded;
	wire internalHasActive;
	wire [1: 0] AXI4EncoderModule_L30F13L39T14_AXI4EncoderModule_L31F30T73_Resize;
	reg [1: 0] AXI4EncoderModule_L30F13L39T14_result;
	integer idx;
	wire [1: 0] AXI4EncoderModule_L30F13L39T14_AXI4EncoderModule_L38F24T41_SignChange;
	wire [1: 0] AXI4EncoderModule_L30F13L39T14_AXI4EncoderModule_L38F24T62_Resize;
	reg AXI4EncoderModule_L45F13L54T14_result;
	integer idx1;
	wire [3: 0] AXI4EncoderModule_L59F40T101_ShiftLeft;
	wire [3: 0] AXI4EncoderModule_L59F40T121_Resize;
	wire [3: 0] AXI4EncoderModule_L59F40T101_Expr;
	wire [3: 0] AXI4EncoderModule_L59F40T101_Expr_1;
	wire Inputs_iValues [0 : 3];
	...
	assign AXI4EncoderModule_L30F13L39T14_AXI4EncoderModule_L31F30T73_Resize = {
		1'b0,
		AXI4EncoderModule_L31F46T51_Expr
	}
	;
