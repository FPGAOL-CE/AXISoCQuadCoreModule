...
//
// System configuration name is AXISoCQuadCoreModule_TopLevel_programmerInterconnect_writeInterconnect_rangeDetectorArray0_encoder, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module AXISoCQuadCoreModule_TopLevel_programmerInterconnect_writeInterconnect_rangeDetectorArray0_encoder
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire iValues0,
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire signed [3: 0] inputWidth = 4'b0101;
	...
	integer idx1;
	wire [4: 0] AXI4EncoderModule_L59F40T101_ShiftLeft;
	wire [4: 0] AXI4EncoderModule_L59F40T121_Resize;
	wire [4: 0] AXI4EncoderModule_L59F40T101_Expr;
	wire [4: 0] AXI4EncoderModule_L59F40T101_Expr_1;
	wire Inputs_iValues [0 : 4];
