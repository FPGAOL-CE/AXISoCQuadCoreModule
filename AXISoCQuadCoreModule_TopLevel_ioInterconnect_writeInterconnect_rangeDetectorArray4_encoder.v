...
//
// System configuration name is AXISoCQuadCoreModule_TopLevel_ioInterconnect_writeInterconnect_rangeDetectorArray4_encoder, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module AXISoCQuadCoreModule_TopLevel_ioInterconnect_writeInterconnect_rangeDetectorArray4_encoder
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	input wire iValues0,
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire signed [4: 0] inputWidth = 5'b01010;
	...
	integer idx1;
	wire [9: 0] AXI4EncoderModule_L59F40T101_ShiftLeft;
	wire [9: 0] AXI4EncoderModule_L59F40T121_Resize;
	wire [9: 0] AXI4EncoderModule_L59F40T101_Expr;
	wire [9: 0] AXI4EncoderModule_L59F40T101_Expr_1;
	wire Inputs_iValues [0 : 9];
	...
	begin
		...
		for (idx1 = 0; (idx1 < 10); idx1 = (idx1 + 1))
		begin
