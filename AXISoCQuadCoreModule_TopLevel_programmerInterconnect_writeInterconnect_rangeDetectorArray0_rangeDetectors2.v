...
//
// System configuration name is AXISoCQuadCoreModule_TopLevel_programmerInterconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors2, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module AXISoCQuadCoreModule_TopLevel_programmerInterconnect_writeInterconnect_rangeDetectorArray0_rangeDetectors2
(
	// [BEGIN USER PORTS]
	// [END USER PORTS]
	...
	wire true = 1'b1;
	wire false = 1'b0;
	wire [31: 0] rangeFrom = 32'b11110001000000000000000000000000;
	wire [31: 0] rangeTo = 32'b11110001000000011111111111111111;
