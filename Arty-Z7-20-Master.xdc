...
#set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports  ck_io3 }; #IO_L16P_T2_13       Sch=CK_IO34
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports  ck_io3 }; #IO_L22N_T3_13       Sch=CK_IO35
#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports  ck_io3 }; #IO_L13N_T2_MRCC_13  Sch=CK_IO36
...
# create_clock -period 10.000 -name VIRTUAL_clk100 -waveform {0.000 5.000}
#set_output_delay -clock [get_clocks clk100] -min -add_delay 0.000 [get_ports {led[*]}]
#set_output_delay -clock [get_clocks clk100] -max -add_delay 0.000 [get_ports {led[*]}]
